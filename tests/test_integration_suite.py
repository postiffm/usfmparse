...
class TestIntegrationSuite:
    ...
    def test_test35_various_markers(self):
        ...
        assert actual == expected, f"Output mismatch:\nExpected: {expected!r}\nActual: {actual!r}"
    def test_test36_various_markers(self):
        """Test 36: Various markers from test36.usfm."""
        actual = parse_and_render(36)
        expected = read_expected_output(36)
        assert actual == expected, f"Output mismatch:\nExpected: {expected!r}\nActual: {actual!r}"
    def test_test37_various_markers(self):
        """Test 37: Various markers from test37.usfm."""
    ...
    def test_test45_and46_booksruntogether(self):
        ...
        assert actual == expected, f"Output mismatch:\nExpected: {expected!r}\nActual: {actual!r}"
    def test_test47_unknown_rq(self):
        """Test 47: Test unknown \rq marker from test47.usfm."""
        actual = parse_and_render(47)
        expected = read_expected_output(47)
        assert actual == expected, f"Output mismatch:\nExpected: {expected!r}\nActual: {actual!r}"
    def test_test48_various_markers(self):
        """Test 48: Test various markers from test48.usfm."""
    ...
    def test_test50_various_markers(self):
        ...
        assert actual == expected, f"Output mismatch:\nExpected: {expected!r}\nActual: {actual!r}"
    def test_test51_various_markers(self):
        r"""Test 51: Test \fq marker"""
        actual = parse_and_render(51)
        expected = read_expected_output(51)
        assert actual == expected, f"Output mismatch:\nExpected: {expected!r}\nActual: {actual!r}"
